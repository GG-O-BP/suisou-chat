...
pub(super) struct AppState {
    ...
    research_job_observations: Signal<HashMap<String, ResearchJobObservation>>,
    research_start_pending: Signal<bool>,
    research_sync_busy: Signal<bool>,
...
impl AppState {
    pub(super) fn new() -> Self {
        Self {
            ...
            research_job_observations: create_signal(HashMap::new()),
            research_start_pending: create_signal(false),
            research_sync_busy: create_signal(false),
...
struct PersistenceRequest {
    ...
    discard_research_request_id: Option<String>,
}
